...
<!-- Form Name -->
<legend>Kemasukan Mesyuarat Baru</legend>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="keterangan" name="keterangan" type="text"  placeholder="Maklumat Ringkas" class="form-control input-md">
	...
	<div class="form-group">
        ...
        <div class="col-md-6">
            <div class="input-group">
                <input id="datepicker" name="datepicker" type="text" class="date-picker form-control" />
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="lokasi" name="lokasi" type="text"  placeholder="Lokasi Mesyuarat" class="form-control input-md">
