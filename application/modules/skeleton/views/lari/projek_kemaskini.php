 ...
 */
	...
	$info = $this->data->projek_papar($this->input->get('id'));	
...
if(isset($_POST['simpan'])){
	...
	$data = array(
                ...
                'nilai_projek' => $this->input->post('nilai')
            	);

	$this->data->projek_ubah($this->input->get('id'),$data);
...
<!-- Form Name -->
<legend>Kemaskini Maklumat Projek </legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="tajuk" value="<?php echo $info->tajuk; ?>" name="tajuk" type="text" placeholder="tajuk"  class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="ringkasan" value="<?php echo $info->maklumat_ringkas; ?>" name="ringkasan" type="text"  placeholder="Maklumat Ringkas" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="perincian" value="<?php echo $info->perincian; ?>" name="perincian" type="text"  placeholder="Maklumat Ringkas" class="form-control input-md">
	...
	<div class="form-group">
        ...
        <div class="col-md-6">
            <div class="input-group">
                <input id="datepicker" value="<?php echo $info->tarikh_jangkaan; ?>" type="text" class="date-picker form-control" />
  ...
  <div class="col-md-6">
    <select id="bahagian" name="bahagian" class="form-control">
      <?php
		...
		$bahagian2 = $this->data->bahagian($info->cawanganid,'1');
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="nilai">Nilai Angaran Projek</label>  
  <div class="col-md-4">
  <input id="nilai" value="<?php echo $info->nilai_projek; ?>" name="nilai" type="text"  placeholder="RM" class="form-control input-md">
