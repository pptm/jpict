<?php
	...
	$jumlah = $this->data->count_projek($cari);

	
	$senarai = $this->data->senarai_projek($jumlah,$offset,$cari);	
...
<div class="col-md-4">
	<div class="col-md-4">
        	<a href="?fungsi=5&lari=baru" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> Baru</a>
  	</div>
	<!--
	<div class="col-md-4">
...
<div class="col-md-12">
	...
	<?php foreach ($senarai as $jumlah): ?>
		...
		<td class="active" width="5%"> <?php echo $bil++; ?></td>
                ...
                <td class="active"><?php echo  $jumlah->maklumat_ringkas; ?></td>
                <td class="active"><?php echo  $jumlah->tarikh_pemohonan; ?></td>
