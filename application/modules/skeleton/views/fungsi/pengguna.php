<?php
	...
	$jumlah = $this->data->count_pengguna($cari);

	
	$senarai = $this->data->senarai_pengguna($jumlah,$offset,$cari);	
...
<div class="col-md-4">
	<div class="col-md-4">
        	<a href="?fungsi=2&lari=baru" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> Baru</a>
  	</div>
	<!--
	<div class="col-md-4">
...
<div class="col-md-12">
	<div class="panel panel-default table-responsive">
        ...
        <thead>
            <tr>
                <th>Bil</th><th>Nama</th><th>email</th><th>Cawangan</th>
            </tr>
        </thead>
        <tbody>
            <?php 
	...
	<?php foreach ($senarai as $jumlah): ?>
		...
		<td class="active" width="5%"> <?php echo $bil++; ?></td>
                <td class="active"><a href="?fungsi=2&lari=ubah&id=<?php echo  $jumlah->email; ?>"><?php echo  $jumlah->Nama; ?></a> </td>
                <td class="active"><?php echo  $jumlah->email; ?></td>
                <td class="active"><?php echo  $this->data->view_cawangan($jumlah->cawangan); ?></td>
