...
<div class="col-md-4">
	<div class="col-md-4">
        	<a href="?fungsi=6&lari=baru" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> Baru</a>
  	</div>
	<!--
	<div class="col-md-4">
...
<div class="col-md-12">
	<div class="panel panel-default table-responsive">
        ...
        <thead>
            <tr>
                <th>Bil</th><th>Tajuk</th><th>Keterangan</th><th>Tarikh</th><th>Lokasi</th><th>Masa</th>
            </tr>
        </thead>
        <tbody>
     <?php 
	...
	<?php foreach ($senarai as $jumlah): ?>
		...
		<td class="active" width="5%"> <?php echo $bil++; ?></td>
                <td class="active"><a href="?fungsi=6&lari=ubah&id=<?php echo  $jumlah->muid; ?>"><?php echo  $jumlah->Tajuk; ?></a> </td>
                <td class="active"><?php echo  $jumlah->keterangan; ?></td>
