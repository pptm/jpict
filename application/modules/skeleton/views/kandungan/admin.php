 ...
 */	
		...
		echo $this->load->view('fungsi/profile'); 
			...
			if ($_GET['lari'] == "baru"){ 
				echo $this->load->view('lari/pengguna_baru');
			}
			else if ($_GET['lari'] == "ubah"){ 
				echo $this->load->view('lari/pengguna_kemaskini');
			}
			...
			if ($peranan == 0):
			echo $this->load->view('fungsi/pengguna');
			else:
			echo $this->load->view('info/block');
			endif;
		     } 
			...
			if (isset($_GET['lari'])){
				...
				if ($_GET['lari'] == "baru"){ 
					echo $this->load->view('lari/cawangan_baru');
				}
				else if ($_GET['lari'] == "ubah"){ 
					echo $this->load->view('lari/cawangan_kemaskini');
				}
				else { echo "Tiada Data"; }
				...
				echo $this->load->view('fungsi/kumpulan'); 

			} 

		}
		else if ($menu == 4){
			echo $this->load->view('fungsi/tetapan'); 
		}
		else{
